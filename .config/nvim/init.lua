...
vim.keymap.set("n", "<leader>fg", "<cmd>Telescope live_grep<CR>", { desc ="Search text in files" })
vim.keymap.set("n", "<leader>h", ":ClangdSwitchSourceHeader <CR>")
vim.keymap.set("n", "gD", vim.lsp.buf.declaration, opts)
vim.keymap.set("n", "K",  vim.lsp.buf.hover, opts)
vim.keymap.set("n", "<leader>n", function()
vim.cmd("vsplit ~/notes/notes.md") end, { desc = "Open notes.md in split" })
vim.keymap.set("v", "<M-c>", '"+y')
vim.keymap.set("v", "<leader>jl", 'cJUCE_LIVE_CONSTANT(<C-r>")<CR><Esc>', { desc = "Wrap selection in JUCE_LIVE_CONSTANT" })
